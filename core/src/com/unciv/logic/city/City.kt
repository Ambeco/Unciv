...
class City : IsPartOfGameInfoSerialization, INamed {
    ...
    @Readonly
    fun getLandAttackPath(destination: City, maxTurns: Int = 128*80): List<Tile>? {
    ...
    @Readonly
    fun getAmphibiousAttackPath(destination: City, maxTurns: Int = 128*80): List<Tile>? {
    ...
    @Readonly
    fun getRoadPath(destination: City, maxTurns: Int = 128*80): List<Tile>? {
